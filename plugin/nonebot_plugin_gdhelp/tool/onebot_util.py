...
async def get_user_name(
    event: Union[
        MessageEvent, GroupIncreaseNoticeEvent, GroupUploadNoticeEvent, NoticeEvent
    ],
    bot: Bot,
    ...
    if isinstance(event, (GroupMessageEvent, GroupIncreaseNoticeEvent, NoticeEvent)):
        ...
        user_name = (
            ...
            if not isinstance(event, GroupUploadNoticeEvent) and event.sender
...
async def get_chat_info(
    ...
    if isinstance(
        event, (GroupUploadNoticeEvent, GroupIncreaseNoticeEvent, NoticeEvent)
    ):
        raw_chat_type = "group"
    else:
